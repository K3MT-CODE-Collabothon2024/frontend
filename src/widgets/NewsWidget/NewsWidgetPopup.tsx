...
import collabotonIcon from '../../data/pictures/Collabothon.png';
import podcastIcon from '../../data/pictures/podcast.png';
import logoIcon from '../../data/pictures/logo_commerzbank.png';  
import womenIcon from '../../data/pictures/women_in_tech.png';

const sampleNewsList: News[] = [
  {
    id: 1,
    title: 'Collabothon 2024',
    image: collabotonIcon,
